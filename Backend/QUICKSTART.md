...
```bash
# Metadata
curl http://localhost:7000/machine/meta | jq

# State
curl http://localhost:7000/machine/state | jq

# Health
curl http://localhost:7000/machine/health | jq

# Control
curl -X POST http://localhost:7000/machine/control \
