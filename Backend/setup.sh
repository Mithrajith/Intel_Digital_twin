...
echo "  uvicorn app.main:app --reload --host 0.0.0.0 --port 7000"
echo ""
echo "Or run directly:"
echo "  venv/bin/uvicorn app.main:app --reload --host 0.0.0.0 --port 7000"
echo ""
echo "API will be available at: http://localhost:7000"
echo "API docs at: http://localhost:7000/docs"
echo ""
