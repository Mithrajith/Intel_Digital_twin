...
1.  **Navigate to the server directory**:
    ```bash
    cd Backend/demo_machine_server
    ```
...
**URL**: `ws://localhost:8000/ws/machines/{machine_id}`
...
*   **"Connection Refused"**: Ensure the server is running. Check if port 8000 is occupied.
