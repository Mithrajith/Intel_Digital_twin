...
def test_frontend_accessibility():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   • Real-time Charts: {FRONTEND_URL}/comprehensive (Real-time tab)")
            print(f"   • AI Predictions: {FRONTEND_URL}/comprehensive (AI tab)")
            print(f"   • Historical Playback: {FRONTEND_URL}/comprehensive (Historical tab)")
            print(f"   • Data Export: {FRONTEND_URL}/comprehensive (Export tab)")
            print(f"   • Control Buttons: {FRONTEND_URL}/comprehensive (Control tab)")
        else:
...
def run_comprehensive_test():
    ...
    print(f"1. Open browser to: {FRONTEND_URL}/comprehensive")
    print("2. Test all 8 tabs: Real-time, AI, Historical, Export, Control, Scenarios, Failures, Maintenance")
    ...
    print("5. Verify emergency stop, scenario injection, maintenance scheduling")
    print("6. Test data export in multiple formats with date ranges")
    print("7. Check interactive timeline scrubber and playback controls")
    print("8. Validate AI predictions with confidence intervals")
